...
/**
 * A time period with a required start time but a possibly not defined end time.
 * Can be easier to work with inside stateful analyzers.
 */
export type OpenEndTimePeriod = {
  start: number;
  end?: number;
};
